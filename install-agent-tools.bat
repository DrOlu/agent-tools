...
set "LARGE_TOOLS=opencode.exe omp.exe usql.exe surreal.exe inngest.exe temporal-server.exe raindrop.exe otelcol.exe otelcol-contrib.exe"
...
:: These exceed GitHub's 100 MB per-file limit and ship as release assets.
